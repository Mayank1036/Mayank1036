...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=24&duration=3000&pause=800&color=00F5FF&center=true&vCenter=true&multiline=false&width=700&height=60&lines=🚀+Java+Backend+Developer;🤖+AI+%26+Data+Science+Explorer;⚡+Problem+Solver+%7C+DSA+Enthusiast;🌐+Full-Stack+Builder+in+Progress;💡+Open+Source+Contributor)](https://git.io/typing-svg)
...
```java
public class MayankSaini {

    private String name        = "Mayank Saini";
    private String username    = "Mayank1036";
    private String education   = "BTech in AI & Data Science (2nd Year)";
    ...
    public String lifePhilosophy() {
        return "Code is not just what I write," +
               " it's how I solve what matters.";
    }
}
```
